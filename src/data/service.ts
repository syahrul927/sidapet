...
import { SKUValidationFieldConfig, SKUValidationSchema } from "./sku/validation"
...
export const ServicesDocument: DynamicPropsArray[] = [
    {
        ...
        notes: "Ketika mengambil surat di Kelurahan, Bawa beberapa persyaratan untuk dijadikan bukti diantaranya: Fotocopy KTP dan Surat Pengantar RT/RW",
    },
    {
        code: "SKDTT",
        documentId: "471.1",
    ...
    },
    {
        ...
        documentId: "474.3 ",
        notes: "Ketika mengambil surat di Kelurahan, Bawa beberapa persyaratan untuk dijadikan bukti diantaranya: Fotocopy KTP jenazah, orang tua dan pelapor ",
    },
]
