...
const passwordFormSchema = z
    .object({
        password: z
            .string({ required_error: "Kata sandi wajib di isi" })
            .min(6, {
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Area berbahaya untuk mengelola password akun.
                                Kamu dapat mengganti kata sandi disini.
                            </CardDescription>
                        </CardHeader>
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Hapus akun tidak dapat dikembalikan. Pastikan akun yang
                        ingin kamu hapus benar!
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
