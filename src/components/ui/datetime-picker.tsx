    ...
    (
        ...
        const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
            ...
            if (["ArrowUp", "ArrowDown"].includes(e.key)) {
                ...
                onDateChange?.(
                    setDateByType(tempDate, newValue, picker, period),
                )
            }
            if (e.key >= "0" && e.key <= "9") {
        ...
        return (
            <Input
                ...
                name={name || picker}
                className={cn(
                    "w-[42px] text-center font-mono text-xs tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
                    className,
                )}
